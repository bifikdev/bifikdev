...
На текущий момент работаю в [https://rozumsoft.ru](https://rozumsoft.ru/)
...
- [https://github.com/teapodlibs](https://github.com/teapodlibs) - Проект библиотек, направленных на разные схемы работы для упрощения написания кода
...
- Symphony - В процессе изучения
- Laravel - В процессе изучения
